...
echo "================================================"
echo "Checking serviceusage.apiKeys.list"

enable_service "apikeys.googleapis.com"
modify_role "serviceusage.apiKeys.list"
...
curl "https://apikeys.clients6.google.com/v1/projects/$PROJECT_ID/apiKeys?access_token=$(cat /tmp/privesc_gcp)"
